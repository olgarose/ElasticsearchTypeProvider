...
let summary = "Elasticsearch Type Provider"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Elasticsearch Type Provider simplifies F# access to Elasticsearch. It ships with F# friendly types (wrapping Nest Query DSL) and generates domain types (F# records) based on Elasticsearch metadata."

// List of author names (for NuGet package)
let authors = [ "Olga Rocheeva" ]

// Tags for your project (for NuGet package)
let tags = "Elasticsearch F# type provider Nest AWS"
...
let gitRaw = environVarOrDefault "gitRaw" "https://raw.githubusercontent.com/olgarose"
